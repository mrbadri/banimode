...
const NewsLetters = () => {
    return ( 
        <div className="NewsLetters px-20 py-10 pb-20 rounded bg-gray-100 relative flex justify-center items-center flex-col">
            ...
            <form className="NewsLetters-form p-4 flex w-7/12 absolute bg-white rounded-full">
                ...
                <button className="bg-green-500 hover:bg-green-600 transition mr-1 text-white py-4 px-8 rounded-full rounded-r-none " >ارسال</button>
            </form>
        </div>
     );
}
